...
function isFresh(row: { requested_at: number; resolved_at: number | null }, nowSec: number): boolean {
      ...
      if (operatorChatId === null) {
        return {
          ...
          error: {
            ...
            message: "Approval operator not configured (APPROVAL_OPERATOR_CHAT_ID or TG_OWNER_CHAT_ID)",
          },
