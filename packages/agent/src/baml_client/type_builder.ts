...
export default class TypeBuilder {
    ...
    ArbitrationSynthesis: ClassViewer<'ArbitrationSynthesis', "synthesis" | "rationale" | "top_roles">;
    
    HippocampusWrite: ClassViewer<'HippocampusWrite', "layer" | "category" | "content" | "tags" | "confidence" | "expires_at" | "supersedes">;
    
    TaskAdd: ClassViewer<'TaskAdd', "title" | "description" | "priority" | "due_at" | "tags">;
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "ArbitrationSynthesis","HippocampusWrite","TaskAdd",
          ]),
          enums: new Set([
        ...
        this.ArbitrationSynthesis = this.tb.classViewer("ArbitrationSynthesis", [
          "synthesis","rationale","top_roles",
        ]);
        
        this.HippocampusWrite = this.tb.classViewer("HippocampusWrite", [
          "layer","category","content","tags","confidence","expires_at","supersedes",
        ]);
        
        this.TaskAdd = this.tb.classViewer("TaskAdd", [
          "title","description","priority","due_at","tags",
        ]);
