...
export function registerTelegramTools(registry: ToolRegistry): void {
  registry.register({
    name: "tg_list_chats",
    description: "List user's Telegram chats (dialogs). Returns chat name, ID, type, unread count.",
    scope: "public",
    input: t.Object({
  ...
  registry.register({
    ...
    description: "Re-include a previously excluded chat (undo tg_exclude_chat).",
    scope: "public",
    input: t.Object({
      chat_id: t.String(),
    }),
  ...
  registry.register({
    ...
    input: t.Object({
      ...
      to: t.Optional(t.String({ description: "ISO date, inclusive upper bound on message time" })),
