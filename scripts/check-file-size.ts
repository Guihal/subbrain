...
export const TRANSITIONAL_WHITELIST: Record<string, number> = {
  ...
  "packages/agent/src/pipeline/agent-loop/tool-runner.ts": 295,
  ...
  "packages/agent/src/mcp/executor/index.ts": 184,
  "packages/core/src/db/tables/agent-tasks.ts": 175,
  ...
  "packages/agent/src/pipeline/agent-pipeline/phases/stream.ts": 185,
  ...
  "packages/core/src/db/tables/shared/shared-crud.ts": 165,
  "packages/agent/src/hooks/dispatcher.test.ts": 160,
