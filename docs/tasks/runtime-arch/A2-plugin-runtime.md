...
Today (`packages/agent/packages/agent/packages/agent/src/mcp/types.ts`):
...
|--------------------------------------|--------------------------------------------------------------------------------|----------------------------------------------------------------------------|------------------------------------------|
| `@subbrain/plugin-code-tool-guards`  | `packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/code-tools/code-tool-validators.ts`                   | `tool.execute.before`                                                      | `create_code_tool`, `edit_code_tool`     |
| `@subbrain/plugin-tg-gates`          | `packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram-spam-gate.ts`                                       | `tool.execute.before`                                                      | `tg_send_message`                        |
| `@subbrain/plugin-scheduled-blacklist` | `packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/code-tools/scheduled-blacklist.ts` (`STATEFUL_CLIENT_CODE_TOOLS`) | conditional registration when `agentMode === "scheduled"`; `tool.execute.before` | scheduled `code_*` tools matching the blacklist |
| `@subbrain/plugin-freelance-scout`   | `packages/agent/packages/agent/packages/agent/src/scheduler/freelance/*`                                                    | none in A2 — wrapped as plugin shell only (scheduler keeps running)        | n/a                                      |
...
```json
{
  ...
  "read_context": [
    ...
    "packages/agent/packages/agent/packages/agent/src/mcp/types.ts",
    "packages/agent/packages/agent/packages/agent/src/mcp/registry/tool-registry.ts:120-160",
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts:95-200"
  ],
  ...
  "escalation_triggers": [
    ...
    "Spec contradicts code: e.g. tool-registry.ts ToolResult is not the union from packages/agent/packages/agent/packages/agent/src/mcp/types.ts — escalate."
  ],
  "glossary": {
...
```json
{
  ...
  "read_context": [
    "docs/tasks/runtime-arch/A2-plugin-runtime.md",
    "packages/plugin/types.ts",
    "packages/core/packages/core/src/lib/logger.ts:1-80"
  ],
  "risk_tier": "public-api",
  "acceptance": [
  ...
  "escalation_triggers": [
    ...
    "logger contract from packages/core/packages/core/src/lib/logger.ts disagrees with the (stage, message, extra) signature documented in CLAUDE.md — escalate.",
...
{
  "task_id": "A2-3",
  "goal": "Insert before/after hook dispatch around the registry call in packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts so that hookless calls produce byte-identical tool_result strings versus main.",
  "non_goals": [
  ...
  "allowed_write_paths": [
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts",
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-dispatch.ts",
  ...
  "acceptance": [
    ...
    "bunx tsc --noEmit",
    "node -e 'const s = require(\"fs\").readFileSync(\"packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts\",\"utf8\"); if (!/hooks/i.test(s)) process.exit(1)'"
  ],
  "diff_budget_loc": 260,
  "file_count_max": 3,
  "rollback": "git restore packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-dispatch.ts tests/agent-loop-hooks.test.ts",
  "escalation_triggers": [
...
{
  "task_id": "A2-4",
  "goal": "Wire chat.params and chat.system.transform into packages/agent/packages/agent/packages/agent/src/pipeline/agent-pipeline/phases/{pre,main,stream}.ts and permission.ask into the tool-runner pre-handler stage; default behavior with zero hooks is unchanged.",
  "non_goals": [
  ...
  "allowed_write_paths": [
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-pipeline/phases/pre.ts",
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-pipeline/phases/main.ts",
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-pipeline/phases/stream.ts",
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts"
  ],
  "read_context": [
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-pipeline/phases/pre.ts",
  ...
  "acceptance": [
    ...
    "bun test tests/agent-loop-hooks.test.ts",
    "bunx tsc --noEmit",
    "grep -q 'chat.system.transform\\|onChatSystemTransform' packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-pipeline/phases/pre.ts",
    "grep -q 'chat.params\\|onChatParams' packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-pipeline/phases/main.ts",
    "grep -q 'permission.ask\\|onPermissionAsk' packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts"
  ],
  "diff_budget_loc": 280,
  "file_count_max": 4,
  "rollback": "git restore packages/agent/packages/agent/packages/agent/src/pipeline/agent-pipeline/phases/ packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts",
  "escalation_triggers": [
...
{
  "task_id": "A2-5",
  "goal": "Add the 5-variant discriminated union alongside the existing ToolResult in packages/agent/packages/agent/packages/agent/src/mcp/types.ts, add toLegacy() shim, and update every direct caller in packages/agent/packages/agent/src/mcp/registry/*, packages/agent/packages/agent/src/mcp/tools/*, packages/agent/packages/agent/packages/agent/src/mcp/executor/index.ts, and packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts to construct results via the new union while preserving the on-the-wire legacy JSON shape.",
  "non_goals": [
  ...
  "allowed_write_paths": [
    "packages/agent/packages/agent/packages/agent/src/mcp/types.ts",
    "packages/agent/packages/agent/packages/agent/src/mcp/registry/tool-registry.ts",
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts",
  ...
  "read_context": [
    "packages/agent/packages/agent/packages/agent/src/mcp/types.ts",
    "packages/agent/packages/agent/packages/agent/src/mcp/registry/tool-registry.ts",
    "packages/agent/packages/agent/packages/agent/src/mcp/registry/code-mgmt.tools.ts",
    "packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram.tools.ts",
    "packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram-spam-gate.ts",
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts",
    "packages/plugin/types.ts"
  ],
  "risk_tier": "public-api",
  "acceptance": [
    ...
    "grep -q 'kind:\\s*\"success\"\\|kind: \"success\"' packages/agent/packages/agent/packages/agent/src/mcp/types.ts",
    "grep -q 'export function toLegacy' packages/agent/packages/agent/packages/agent/src/mcp/types.ts || grep -q 'export const toLegacy' packages/agent/packages/agent/packages/agent/src/mcp/types.ts"
  ],
  "diff_budget_loc": 290,
  "file_count_max": 4,
  "rollback": "git restore packages/agent/packages/agent/src/mcp/ packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/tool-runner.ts tests/tool-result-shape.test.ts",
  "escalation_triggers": [
...
```json
{
  ...
  "read_context": [
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/code-tools/code-tool-validators.ts",
    "packages/agent/packages/agent/packages/agent/src/mcp/registry/code-mgmt.tools.ts",
  ...
  "acceptance": [
    ...
    "bunx tsc --noEmit",
    "test ! -f packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/code-tools/code-tool-validators.ts || grep -q '@deprecated' packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/code-tools/code-tool-validators.ts",
  ...
  "diff_budget_loc": 250,
  "file_count_max": 4,
  "rollback": "git restore packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/code-tools/code-tool-validators.ts packages/agent/packages/agent/packages/agent/src/mcp/registry/code-mgmt.tools.ts && git rm -rf packages/agent/plugins-internal/code-tool-guards",
  "escalation_triggers": [
    ...
    "More than one caller of applyCodeToolGuards exists outside packages/agent/packages/agent/packages/agent/src/mcp/registry/code-mgmt.tools.ts — escalate."
  ],
  "glossary": {
...
{
  "task_id": "A2-7",
  "goal": "Move packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram-spam-gate.ts into packages/agent/plugins-internal/tg-gates/ as a Plugin that registers tool.execute.before on tg_send_message; remove the inline checkSpamGate call from packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram.tools.ts.",
  "non_goals": [
  ...
  "acceptance": [
    ...
    "test ! -f packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram-spam-gate.ts || grep -q '@deprecated' packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram-spam-gate.ts"
  ],
  "notes": [
  ...
  "diff_budget_loc": 220,
  "file_count_max": 4,
  "rollback": "git restore packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram.tools.ts packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram-spam-gate.ts && git rm -rf packages/agent/plugins-internal/tg-gates",
  "escalation_triggers": [
    ...
    "checkSpamGate has callers outside packages/agent/packages/agent/packages/agent/src/mcp/registry/telegram.tools.ts — escalate."
  ],
  "glossary": {
...
{
  "task_id": "A2-8",
  "goal": "Move packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/code-tools/scheduled-blacklist.ts into packages/agent/plugins-internal/scheduled-blacklist/ as a context-conditional Plugin loaded only when ctx.agentMode === 'scheduled'; wrap packages/agent/packages/agent/packages/agent/src/scheduler/freelance/* into packages/agent/plugins-internal/freelance-scout/index.ts as a no-op Plugin shell that re-exports the existing scheduler entry points.",
  "non_goals": [
  ...
  "read_context": [
    "packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/code-tools/scheduled-blacklist.ts",
    "packages/agent/packages/agent/packages/agent/src/mcp/registry/tool-registry.ts",
    "packages/agent/packages/agent/packages/agent/packages/agent/src/scheduler/freelance/index.ts",
  ...
  "diff_budget_loc": 220,
  "file_count_max": 4,
  "rollback": "git restore packages/agent/packages/agent/packages/agent/packages/agent/src/pipeline/agent-loop/code-tools/scheduled-blacklist.ts packages/agent/packages/agent/packages/agent/src/mcp/registry/tool-registry.ts && git rm -rf packages/agent/plugins-internal/scheduled-blacklist packages/agent/plugins-internal/freelance-scout",
  "escalation_triggers": [
    "Test 'tool list in scheduled mode hides STATEFUL_CLIENT_CODE_TOOLS names' fails — escalate; this is the primary defense.",
    "packages/agent/packages/agent/src/scheduler/freelance has more than one entry point or non-trivial start/stop lifecycle leakage — escalate before wrapping.",
...
{
  "task_id": "A2-9",
  "goal": "Add packages/agent/plugins-internal.ts exporting INTERNAL_PLUGINS in fixed order [code-tool-guards, tg-gates, scheduled-blacklist, freelance-scout]; wire boot-time setup() in packages/server/packages/server/packages/server/src/app/bootstrap.ts so all four plugins register against the global HooksDispatcher exactly once at startup.",
  "non_goals": [
  ...
  "allowed_write_paths": [
    ...
    "packages/server/packages/server/packages/server/src/app/bootstrap.ts",
  ...
  "acceptance": [
    ...
    "grep -q 'INTERNAL_PLUGINS\\|setupInternalPlugins' packages/server/packages/server/packages/server/src/app/bootstrap.ts"
  ],
  "diff_budget_loc": 200,
  "file_count_max": 4,
  "rollback": "git restore packages/server/packages/server/packages/server/src/app/bootstrap.ts packages/server/packages/server/packages/server/src/app/deps.ts && git rm -f packages/agent/plugins-internal.ts tests/plugins-internal-boot.test.ts",
  "escalation_triggers": [
  ...
  "glossary": {
    ...
    "boot-time wire": "packages/server/packages/server/packages/server/src/app/bootstrap.ts constructs HooksDispatcher, then iterates INTERNAL_PLUGINS calling setup({ hooks }) on each, before AgentPipeline / scheduler installation."
  }
}
```
