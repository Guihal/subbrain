...
- [packages/core/src/db/schema.ts:305](../../../packages/core/src/db/schema.ts#L305) — `CHECK(role IN ('user','assistant','system','tool','reasoning'))`.
...
- [packages/agent/src/telegram/userbot/index.ts:319-325](../../../packages/agent/src/telegram/userbot/index.ts#L319-L325) — role `channel_message`. Тот же провал.
...
- [packages/core/src/db/schema.ts](../../../packages/core/src/db/schema.ts) — migration 6.
